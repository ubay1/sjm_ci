...
<div class="jumbotron">
	<h1 class="text-center txtjumbotron">
		<span class="mdi mdi-settings mdi-spin"></span> SERVIS DARUAT <span class="mdi mdi-settings mdi-spin"></span>
	</h1>
</div>
	...
	<form action="<?= base_url('sjm/pesananumum') ?>" method="POST" id="form" class="container-fluid">
		...
		<div class=" lebar-form">
			...
			<div class="pembungkus-forminput">
				...
				<input required placeholder="masukan alamat anda saat ini" class="form-control  forms"  name="alamat" id="alamat" type="text" value="">
			</div>
		</div>
		...
		<div class="lebar-form">
			<div class="pembungkus-forminput">
				...
				<input  required class="form-control  forms"  name="waktu_pengerjaan" id="waktu_pengerjaan" type="text" placeholder="dd-mm-yyyy H:i:s" value="<?= date('Y-m-d H:i:s'); ?>" autocomplete="off">
			</div>
