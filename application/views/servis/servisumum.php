...
<div class="servis">
	<div class="bg_img_servis">
		<img src="<?= base_url() ?>assets/images/bg_servisumum.jpg" class="img_servis">
	</div>
...
<script type="text/javascript">
	...
	// 		swal({
	// 			title:'',
	// 			text:'cek harga servis sebelum memesan, agar tidak terjadi kesalah pahaman',
	// 			type:'info',
	// 			confirmButtonColor:'#35A9C6'
	// 		});
	// 	}, 5000);
	// });
</script>
